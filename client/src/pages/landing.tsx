...
/**
 * Renders the public landing page with header, hero, features grid, and footer.
 *
 * Displays a full-screen loading message while authentication status is being determined.
 * The primary call-to-action buttons navigate to `/dashboard` when the user is authenticated or to `/api/login` when not.
 *
