...
/**
 * Render the authenticated user's dashboard with profile, links, bio-pages management, quick stats, and analytics.
 *
 * Displays loading indicators while authentication or bio/profile data is being fetched. If the user has no
 * bio pages, shows a welcome screen with the BioPagesManager; if bio pages exist but no active profile is selected,
 * shows the BioPagesManager for selection; when a profile is available, renders the full dashboard (wrapped by
 * ThemeProvider) including profile settings, link management, quick statistics, and modals for adding/editing links,
 * editing the profile, and customizing the theme.
 *
 * When the user is unauthenticated, shows an unauthorized toast and navigates the browser to /login.
 *
 * @returns The dashboard JSX element. Returns `null` when the user is unauthenticated.
 */
