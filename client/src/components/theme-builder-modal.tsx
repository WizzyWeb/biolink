...
/**
 * Modal UI for building, previewing, and applying a theme to a user profile.
 *
 * Fetches preset themes when opened, lets the user edit colors, gradients, fonts, and layout,
 * previews changes live, and persists + activates the selected theme for the given profile when saved.
 *
 * @param isOpen - Controls whether the modal is visible.
 * @param onClose - Callback invoked to request closing the modal.
 * @param profileId - Identifier of the profile that the saved theme will be associated with.
 * @returns The rendered modal element, or `null` when the current theme is not available.
 */
