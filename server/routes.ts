...
/**
 * Registers all HTTP routes and middleware on the provided Express app.
 *
 * Attaches session handling, authentication routes, protected and public API
 * endpoints for users, profiles, bio pages, links, themes, and analytics, then
 * returns an HTTP server that wraps the configured app.
 *
 * @param app - The Express application to attach routes and middleware to
 * @returns The HTTP server instance wrapping the configured Express app
 */
