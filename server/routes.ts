...
/**
 * Register API routes on the given Express application and create an HTTP server from it.
 *
 * Sets up authentication and mounts endpoints for user auth, profile retrieval and updates,
 * social link CRUD and reordering, click tracking, and analytics.
 *
 * @param app - The Express application to register routes on
 * @returns An HTTP Server created from the provided Express app
 */
